...
**一句话描述**：掌门视角的东方玄幻文字修真游戏

**核心体验**：
玩家将扮演宗门掌门，通过管理宗门、培养弟子、参与试炼等方式，体验修真世界的成长与发展，感受宗门经营与角色修炼的双重乐趣。
...
- **三色资源模型**：灵石（通用货币）+ 贡献值（内部凭证）+ 功法残卷（稀缺收集）
...
| 资源类型 | 定位 | 获取方式 | 消耗场景 | 是否可交易 |
|---------|------|---------|---------|-----------|
| **灵石** | 通用货币 | 灵脉产出、区域占领、试炼奖励、交易 | 外部交易、高级资源购买、俸禄发放、设施运行 | 是 |
| **贡献值** | 内部凭证 | 任务完成、资源贡献、设施建设、试炼表现 | 功法学习、职务晋升、设施使用、特殊资源购买权 | 否（个人专属） |
| **功法残卷** | 稀缺收集 | 古战场探索、秘境奖励、击败强敌、随机事件 | 功法合成、功法传承、研究新技艺 | 是（有限交易） |

**灵石经济循环**：
- 产出：灵脉产出、区域占领、试炼奖励、交易行、随机事件
- 消耗：资源购买、装备打造、俸禄发放、设施建设、加速道具
- 平衡：交易行手续费作为灵石回收手段

**贡献值循环**：
- 获取：宗门任务（40%）、宗门战/活动（30%）、资源贡献（20%）、特殊成就（10%）
- 用途：功法学习资格、职务晋升、特殊资源购买权、宗门大比参与资格
- 特性：个人专属，不可转移，不可交易

**功法残卷循环**：
- 获取：探索掉落、秘境奖励、击败 Boss、随机事件
- 用途：合成完整功法、研究新技艺、功法传承
- 特性：随机性 + 收集养成，支撑长期玩法
...
玩家固定为掌门视角，作为宗门最高决策者，负责管理宗门事务、制定发展战略、任命长老等。

**掌门核心体验**：
- 体验宗门经营的全局视角，决策影响整个宗门的发展
- 通过资源分配、设施建设、弟子培养等方式发展宗门
- 参与试炼挑战，获取高级资源和功法
- 与其他宗门进行外交活动，建立联盟或宣战
...
| 层级 | 区域类型 | 说明 |
|------|---------|------|
| **世界地图** | 所有可探索和占领的区域 | 按难度星级划分，包含资源产出、试炼任务、随机事件 |
| **宗门领地** | 宗门核心区域 | 宗门设施建设与管理的焦点，玩家"家"的归属感 |

**逻辑三层结构**（世界地图内部）：

| 逻辑层 | 说明 | 玩法价值 |
|-------|------|---------|
| **资源层** | 灵草区、矿脉区、妖兽区等 | 日常资源获取，基础试炼 |
| **试炼层** | 灵脉区、古战场等 | 高级资源获取，中高难度挑战 |
| **事件层** | 秘境、禁地等 | 稀有资源，顶级挑战，剧情事件 |

**区域难度划分**：

| 难度 | 区域命名示例 | 对应修为 | 资源等级 | 解锁条件 |
|------|-------------|---------|---------|---------|
| ★☆☆ | 青云坡、落叶谷 | 炼气期 | 基础资源 | 初始解锁 |
| ★★☆ | 黑风林、寒潭洞 | 筑基期 | 中级资源 | 弟子达 10 人 |
| ★★★ | 妖兽森林、古修洞府 | 金丹期 | 高级资源 | 突破金丹期 |
| ★★★★ | 上古秘境、禁地 | 元婴期 | 稀有资源 | 特殊任务解锁 |
| ★★★★★ | 仙界遗迹 | 化神期 | 顶级资源 | 完成前置探索 |

**区域群概念**（增加策略性）：
- 区域群包含多个小区域，如"东部区域群"包含灵草区、矿脉区、妖兽区
- 占领区域群内全部小区域后，解锁"区域控制"加成
- 区域群之间有"灵气属性"差异（金木水火土）
- 某些功法需要特定区域群的资源修炼
...
| 版本 | 周期 | 阶段名称 | 核心任务 | 交付物 | 成功标准 |
|------|------|---------|---------|-------|---------|
| **V1.0** | **第 1-4 周** | **MVP 基础版** | 1. 单一掌门视角<br>2. 三色资源模型（灵石 + 贡献值 + 功法残卷）<br>3. 基础宗门管理<br>4. 弟子成长修炼<br>5. 基础战斗试炼<br>6. 两层地图结构 | 1. 可运行的 MVP 版本<br>2. 核心玩法循环完整<br>3. 基础 UI 界面 | 1. 从创建宗门到参与试炼全流程打通<br>2. 资源流动正确<br>3. 弟子可正常修炼突破 |
| **V1.1** | **第 5-7 周** | **体验完善版** | 1. 师徒社交系统<br>2. 事件系统完善<br>3. 地图两层结构完善<br>4. UI 优化<br>5. 性能优化 | 1. V1.1 版本<br>2. 师徒关系功能<br>3. 优化的 UI 界面 | 1. 师徒关系正常运作<br>2. 事件丰富度提升<br>3. UI 操作流畅 |
| **V1.2** | **第 8-10 周** | **内容丰富版** | 1. 宗门外交系统<br>2. 任务系统<br>3. 成就系统<br>4. 更多随机事件<br>5. 数值平衡优化 | 1. V1.2 正式版<br>2. 完整的外交系统<br>3. 任务成就系统 | 1. 宗门间可建立外交<br>2. 任务系统完整<br>3. 数值平衡良好 |

#### V1.0 MVP 详细周计划

| 周数 | 核心任务 | 具体任务 | 交付物 |
|------|---------|---------|-------|
| **第 1 周** | **项目框架 + 核心数据模型** | 1. 搭建项目基础架构<br>2. 设计核心数据模型（角色、宗门、资源）<br>3. 实现数据持久化<br>4. 实现基础 UI 框架 | 1. 可运行的项目框架<br>2. 核心数据模型<br>3. 数据存取功能 |
| **第 2 周** | **宗门管理 + 资源系统** | 1. 实现宗门基础功能<br>2. 实现三色资源系统<br>3. 资源获取/消耗/分配<br>4. UI 界面实现 | 1. 宗门管理功能<br>2. 三色资源循环<br>3. 资源管理 UI |
| **第 3 周** | **成长系统 + 战斗系统** | 1. 实现弟子修炼系统<br>2. 实现境界突破机制<br>3. 实现基础战斗（文字回合制）<br>4. 战斗结算功能 | 1. 成长系统<br>2. 战斗系统<br>3. 突破功能 |
| **第 4 周** | **试炼系统 + 整合测试** | 1. 实现试炼系统<br>2. 两层地图结构<br>3. 全流程整合测试<br>4. Bug 修复 | 1. 试炼系统<br>2. 地图功能<br>3. MVP 完整版本 |

#### 里程碑评审点

| 评审点 | 时间 | 评审内容 | 参与人员 | 决策标准 |
|-------|------|---------|---------|---------|
| **V1.0 评审** | 第 4 周末 | MVP 版本、核心玩法循环 | 所有开发团队成员 | 1. 核心玩法是否完整<br>2. 三色资源是否平衡<br>3. 是否可以发布 |
| **V1.1 评审** | 第 7 周末 | 师徒系统、事件系统、UI | 所有开发团队成员 | 1. 社交功能是否完整<br>2. UI 是否优化<br>3. 体验是否提升 |
| **V1.2 评审** | 第 10 周末 | 外交系统、任务成就、正式版 | 所有开发团队成员 | 1. 所有功能是否正常<br>2. 数值是否平衡<br>3. 是否可以正式发布 |
...
**发布平台**：PC（Steam、itch.io 等）

**区域规划**：全球发布，支持中文

**版本发布计划**：

| 版本 | 发布时间 | 核心功能 | 社交系统 | 目标 |
|------|---------|---------|---------|------|
| **V1.0** | 第 4 周末 | 掌门视角、三色资源、基础宗门、成长修炼、战斗试炼、两层地图 | 无 | MVP 可发布，验证核心玩法 |
| **V1.1** | 第 7 周末 | 设施升级、事件系统完善、UI 优化 | 师徒关系 | 体验完善，增加社交深度 |
| **V1.2** | 第 10 周末 | 完整试炼、数值平衡、更多随机事件 | 宗门外交 | 内容丰富，正式版本 |
...
- **任务系统**：生成、接受和完成各种任务，增加游戏目标感
- **成就系统**：解锁各种游戏成就，提供长期目标
- **统计分析**：统计宗门发展、弟子成长等数据，提供发展建议
- **更多随机事件**：增加事件多样性，提升可玩性
- **功法残卷扩展**：增加更多功法残卷种类和合成配方
- **区域群扩展**：增加新的区域群和灵气属性
- **长老系统深化**：增加长老专属功能和决策深度
...
| **贡献值** | 宗门内部凭证（非货币），用于功法学习、职务晋升等，个人专属不可交易 | - |
| **功法残卷** | 稀缺收集资源，通过探索、秘境、击败强敌获得，用于合成完整功法 | - |
| **三色资源模型** | 灵石（通用货币）+ 贡献值（内部凭证）+ 功法残卷（稀缺收集）的经济系统设计 | - |
| **世界地图** | 所有可探索和占领的区域，按难度星级划分 | - |
| **宗门领地** | 宗门核心区域，设施建设与管理的焦点 | - |
| **区域群** | 包含多个小区域的地理分组，如"东部区域群" | - |
| **P0-A** | MVP 核心功能，必须在第一版发布时完成 | - |
| **P0-B** | 重要功能，可在后续迭代中完成 | - |
| **P1** | 次要功能，提升游戏体验 | - |
| **P2** | 扩展功能，增强游戏深度 | - |
...
| 版本 | 日期 | 修改内容 | 修改人 |
|-----|------|---------|-------|
| v1.3 | 2026-02-28 | 1. 移除 4 种游戏模式，改为单一掌门视角<br>2. 移除全部技术相关内容（ECS 架构等）<br>3. 经济系统改为三色资源模型（灵石 + 贡献值 + 功法残卷）<br>4. 地图结构改为物理两层 + 逻辑三层<br>5. 开发计划调整为 10 周 3 版本（V1.0/V1.1/V1.2）<br>6. 社交系统分期实现（V1.1 师徒→V1.2 外交） | AI Assistant |
