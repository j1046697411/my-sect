...
class DiscipleCardTest {
    @Test
    fun discipleCard_displaysNameAndRealm() = runComposeUiTest {
        setContent {
            SectTheme {
    ...
    @Test
    fun discipleCard_displaysCultivationProgress() = runComposeUiTest {
        setContent {
            SectTheme {
    ...
    @Test
    fun discipleCard_displaysHighFatigueWarning() = runComposeUiTest {
        setContent {
            SectTheme {
    ...
    @Test
    fun discipleCard_expandedShowsDetails() = runComposeUiTest {
        setContent {
            SectTheme {
                DiscipleCard(
