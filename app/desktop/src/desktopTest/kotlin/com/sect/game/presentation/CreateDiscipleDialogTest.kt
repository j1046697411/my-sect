...
class CreateDiscipleDialogTest {
    @Test
    fun dialog_createButtonExistsWhenNameEmpty() = runComposeUiTest {
        setContent {
            SectTheme {
    ...
    @Test
    fun dialog_createButtonExistsAfterNameInput() = runComposeUiTest {
        setContent {
            SectTheme {
                CreateDiscipleDialog(
                    container = TestData.testContainer(),
    ...
    @Test
    fun dialog_createButtonExistsAfterRandomClick() = runComposeUiTest {
        setContent {
            SectTheme {
                CreateDiscipleDialog(
                    container = TestData.testContainer(),
