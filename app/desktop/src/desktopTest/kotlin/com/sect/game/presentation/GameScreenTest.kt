...
class GameScreenTest {
    ...
    @Test
    fun emptyContent_displaysNoDisciplesMessage() = runComposeUiTest {
        setContent {
            SectTheme {
                EmptyContent()
            }
    ...
    @Test
    fun loadingContent_doesNotDisplayEmptyMessage() = runComposeUiTest {
        setContent {
            SectTheme {
                LoadingContent()
            }
    ...
    @Test
    fun gameScreen_rendersWithTestContainer() = runComposeUiTest {
        setContent {
            SectTheme {
