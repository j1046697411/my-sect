...
object GoalFactoryImpl {
    private val goalTemplates: Map<String, GoalTemplate> = mapOf(
        SurvivalGoal.ID to GoalTemplate(
            id = SurvivalGoal.ID,
            name = "生存",
        ...
        CultivationGoal.ID to GoalTemplate(
        ...
        BreakthroughGoal.ID to GoalTemplate(
