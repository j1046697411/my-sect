...
interface ActionExecutor {
    fun execute(disciple: Disciple, action: Action): Disciple
}
...
class DefaultActionExecutor : ActionExecutor {
    ...
    private fun applyEffect(disciple: Disciple, effect: com.sect.game.goap.core.Effect): Disciple {
        ...
        return when (effect.key) {
            ...
            "cultivationProgress" -> disciple.copy(cultivationProgress = (disciple.cultivationProgress + effect.delta).coerceIn(0, 100))
            "realm" -> {
